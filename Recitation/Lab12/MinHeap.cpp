...
/*
Returns the right child of a node. Return index.
*/
...
int MinHeap::extractMin()
{
  ...
  //delete first element in array and then
  int tempMin = heapArr[0];
...
//EXTRA CREDIT--------------------------------------------
// 15% EXTRA CREDIT if you implement an associative array
