...
// First modify the findShortestPath function to update the pred(pred) when updating the distance of the adjacent vertices,
...
int Graph::findShortestPath(int src, int dest){
    ...
    while(!q.empty()){
        ...
        for( int x = 0; x < n->adj.size(); x++ )
        {
            ...
            //when all adjacent nodes have been visited, pop from queue
            // Stop both loops once key has been found
